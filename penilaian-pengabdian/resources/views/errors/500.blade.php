...
<body>
    <div class="error-card">
        <div class="card shadow-sm border-0 p-4">
            ...
            <h4 class="fw-bold text-dark mb-2">Kesalahan Internal Server</h4>
            <p class="text-muted mb-4">Terjadi kesalahan pada server. Silakan coba lagi nanti atau hubungi administrator.</p>
