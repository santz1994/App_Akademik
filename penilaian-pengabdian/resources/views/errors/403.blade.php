...
<body>
    <div class="error-card">
        <div class="card shadow-sm border-0 p-4">
            ...
            <div class="error-icon my-3"><i class="bi bi-shield-exclamation"></i></div>
            <h4 class="fw-bold text-dark mb-2">Akses Ditolak</h4>
            <p class="text-muted mb-4">Anda tidak memiliki izin untuk mengakses halaman ini. Silakan hubungi administrator jika Anda merasa ini adalah kesalahan.</p>
