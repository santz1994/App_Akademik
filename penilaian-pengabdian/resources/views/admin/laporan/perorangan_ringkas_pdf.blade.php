...
<head>
    <meta charset="UTF-8">
    <title>Laporan Nilai Pegawai (Ringkas)</title>
    @php
    ...
    <style>
        ...
        table.score-table td.no { width: 40px; text-align: center; }
        table.score-table td.nama { }
        table.score-table td.nilai { width: 120px; text-align: center; font-weight: 700; font-size: 12px; }
...
<body>
    <div class="header-wrap">
        ...
        <div class="header-center">
            <h1 class="header-title">Laporan Nilai Pegawai (Ringkas)</h1>
    ...
    <div class="summary-box">
        <div class="summary-item">
            ...
            <div class="summary-value">
                {{ (isset($perPangkalanData) && $perPangkalanData['kinerjaFinal'] !== null) ? number_format($perPangkalanData['kinerjaFinal'], 2) : '-' }}
            </div>
        ...
        <div class="summary-item">
            ...
            <div class="summary-value">
                {{ (isset($perPangkalanData) && $perPangkalanData['kegiatanAvg'] !== null) ? number_format($perPangkalanData['kegiatanAvg'], 2) : '-' }}
            </div>
        </div>
        <div class="summary-item">
