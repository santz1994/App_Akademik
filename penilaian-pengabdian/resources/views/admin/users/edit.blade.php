...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            @if($user->is_kepala)
            <div class="mb-3">
                <label class="form-label fw-semibold">Status Kepala</label>
                <div>
                    <span class="badge bg-warning text-dark"><i class="bi bi-star me-1"></i>Kepala Pimpinan Pos</span>
                    <small class="text-muted d-block mt-1">Status kepala ditentukan dari data pangkalan. Untuk mengubah, edit data pangkalan terkait.</small>
                </div>
            </div>
            @endif
